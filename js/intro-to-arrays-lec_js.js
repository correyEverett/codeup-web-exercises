...
var favoriteFoods = ['salmon', 'sushi', 'salsa'];
...
// console.log('The number of indices (length) in shapes is ' + shapes.length);
//
// // TODO: console.log the length of the instructors array
// console.log('The number of indices (length) in instructors is ' + instructors.length);
// // TODO: console.log the length of the daysOfTheWeek array
// console.log('The number of indices (length) in daysOfTheWeek is ' + daysOfTheWeek.length);
// // TODO: console.log the length of the favoriteFoods array
// console.log('The number of indices (length) in favoriteFoods is ' + favoriteFoods.length);
...
//             alert(shapes[i] + 's ae my favorite shape!');
//         }
//     }

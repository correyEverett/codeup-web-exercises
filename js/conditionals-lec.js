...
//TODO Together: Write an if statement that alerts "It's raining" if isRaining is true
...
function buyIt(itemCost, currentBalance) {
    if(itemCost > currentBalance) {
        alert('Sorry you don\'t have enough money!');
    } else {
        alert('You can buy the item');
...
var numberOfLives = Math.floor(Math.random() * 2);

// if(numberOfLives === 0) {
//     alert('Sorry, game over');
// } else {
//     alert('You\'re still in the game!')
// }
...
if(userAge < 15) {
    ...
    if(userAge = 15) {
        ...
        alert('you can get a license today')
    }
}
